...
import ch.philnet.tagguard.commands.AliveCommand;
import ch.philnet.tagguard.commands.Command;
import ch.philnet.tagguard.commands.CommandsCommand;
import ch.philnet.tagguard.commands.StopCommand;
...
public class BotService {
    ...
    public void run(final Room room, String location) {
        ...
        room.send(String.format("[ [TagGuard](https://sobotics.org) ] started on %s.", location));
